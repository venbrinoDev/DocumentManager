...
public class FileViewAdapter extends RecyclerView.Adapter<FileViewAdapter.ViewHolder>{
    ...
    String [] extension = {"Kb","Mb","Gb","Tb"};

    public FileViewAdapter(ArrayList<FileViewModel> documents, Context globalContext,RecyclerViewClick recyclerViewClick,NotifyFragment notifyFragment) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(globalContext).inflate(R.layout.file_row_linear,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String size =CalculateClass.readableFileSize(model.getSize());

        numberOfFile.setText(size);

        holder.dateModified.setText(CalculateClass.getDateOuOfTimeStanp(model.getDate()));
    ...
    private float returnValue(float byteValue){
      if (byteValue>1024){
          returnValue(CalculateClass.calculateSize(byteValue));
      }
      return byteValue;
    }
...
//        }
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView name, numbeer,fullPath,dateModified;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            dateModified = itemView.findViewById(R.id.dateModified);
