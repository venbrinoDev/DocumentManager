...
import company.android.documentmanager.office.java.awt.Image;
import company.android.documentmanager.office.java.awt.Shape;
import company.android.documentmanager.office.java.awt.Stroke;
import company.android.documentmanager.office.java.awt.geom.AffineTransform;
import company.android.documentmanager.office.java.awt.geom.Area;
import company.android.documentmanager.office.java.awt.geom.GeneralPath;
import company.android.documentmanager.office.java.awt.geom.IllegalPathStateException;
...
import company.android.documentmanager.office.datatatdhd.emf.data.BasicStroke;
...
{
    private static final Logger logger = Logger.getLogger("company.android.documentmanager.office.thirdpart.emf");
...
//        canvas.clipRect(rect);
     ...
     *  g2 Context to apply transformations
     */
...
//            g2.setClip(dc.clip);
     ...
     *  g2 Painting context
     *  s Shape to fill with current brush
     */
...
//            drawShape(g2, s);
     ...
     *  g2 Painting context
     *  s Shape to draw with current paen
     */
...
//		penPaint.setStrokeMiter(10.0f);
     ...
     *
     *  g2 Painting context
     *  s Shape to draw with current pen
     */
