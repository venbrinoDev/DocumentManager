...
public class SectionIDMap extends HashMap {
     ...
     * ID.</p>
     *
     *  sectionFormatID A section format ID as a <tt>byte[]</tt> .
     ...
     *
     *  key This parameter remains undocumented since the method is
     * deprecated.
     *  value This parameter remains undocumented since the method is
     * deprecated.
