...
package company.android.documentmanager.office.fc.hssf.formula;
...
import company.android.documentmanager.office.fc.hssf.formula.CollaboratingWorkbooksEnvironment.WorkbookNotFoundException;
import company.android.documentmanager.office.fc.hssf.formula.eval.AreaEval;
import company.android.documentmanager.office.fc.hssf.formula.eval.BlankEval;
import company.android.documentmanager.office.fc.hssf.formula.eval.BoolEval;
import company.android.documentmanager.office.fc.hssf.formula.eval.ErrorEval;
import company.android.documentmanager.office.fc.hssf.formula.eval.EvaluationException;
import company.android.documentmanager.office.fc.hssf.formula.eval.MissingArgEval;
import company.android.documentmanager.office.fc.hssf.formula.eval.NameEval;
import company.android.documentmanager.office.fc.hssf.formula.eval.NotImplementedException;
import company.android.documentmanager.office.fc.hssf.formula.eval.NumberEval;
import company.android.documentmanager.office.fc.hssf.formula.eval.OperandResolver;
import company.android.documentmanager.office.fc.hssf.formula.eval.RefEval;
import company.android.documentmanager.office.fc.hssf.formula.eval.StringEval;
import company.android.documentmanager.office.fc.hssf.formula.eval.ValueEval;
import company.android.documentmanager.office.fc.hssf.formula.function.Choose;
import company.android.documentmanager.office.fc.hssf.formula.function.FreeRefFunction;
...
import company.android.documentmanager.office.fc.hssf.formula.ptg.AreaErrPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.AreaPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.AttrPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.BoolPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.ControlPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.DeletedArea3DPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.DeletedRef3DPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.ErrPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.ExpPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.FuncVarPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.IntPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.MemAreaPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.MemErrPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.MemFuncPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.MissingArgPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.NamePtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.NameXPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.NumberPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.OperationPtg;
...
import company.android.documentmanager.office.fc.hssf.formula.ptg.RefErrorPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.RefPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.StringPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.UnionPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.UnknownPtg;
import company.android.documentmanager.office.fc.hssf.formula.udf.AggregatingUDFFinder;
import company.android.documentmanager.office.fc.hssf.formula.udf.UDFFinder;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFEvaluationWorkbook;
import company.android.documentmanager.office.fc.ss.usermodel.ICell;
import company.android.documentmanager.office.fc.ss.util.CellReference;
import company.android.documentmanager.office.ss.model.XLSModel.ACell;
...
public final class WorkbookEvaluator {
	...
	/**
	 *  udfFinder pass <code>null</code> for default (AnalysisToolPak only)
	 */
