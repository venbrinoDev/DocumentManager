...
import company.android.documentmanager.office.fc.hssf.formula.ptg.TblPtg;
...
import company.android.documentmanager.office.fc.util.LittleEndianByteArrayInputStream;
import company.android.documentmanager.office.fc.util.LittleEndianInput;
import company.android.documentmanager.office.fc.util.LittleEndianOutput;
...
public class Formula {
	 ...
	 *  totalEncodedLen the total number of bytes in the formula (includes trailing encoding
	...
	/**
	 * Gets the locator for the corresponding {@link company.android.documentmanager.office.fc.hssf.record.SharedFormulaRecord},
     * {@link company.android.documentmanager.office.fc.hssf.record.ArrayRecord} or {@link company.android.documentmanager.office.fc.hssf.record.TableRecord}
