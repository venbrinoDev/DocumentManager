...
package company.android.documentmanager.office.fc.hssf.util;



import company.android.documentmanager.office.fc.hssf.usermodel.HSSFCell;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFCellStyle;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFFont;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFRow;
...
import company.android.documentmanager.office.fc.ss.util.CellUtil;
...
public final class HSSFCellUtil {
     ...
     *
     *  workbook               The workbook that is being worked with.
     *  propertyName           The name of the property that is to be
     *      changed.
     *  propertyValue          The value of the property that is to be
     *      changed.
