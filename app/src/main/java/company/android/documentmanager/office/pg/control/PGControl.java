...
import company.android.documentmanager.office.mycommsmoms.ICustomDialog;
...
import company.android.documentmanager.office.system.AbstractControl;
    ...
    public void actionEvent(int actionID, final Object obj)
    {
        switch (actionID)
        {
            ...
            case EventConstant.PG_NOTE_ID:                          //show notes
                ...
                vector.add(text);
                new company.android.documentmanager.office.pg.dialog.NotesDialog(this, getMainFrame().getActivity(), null, vector,
