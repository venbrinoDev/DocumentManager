...
import company.android.documentmanager.office.fc.POIDocument;
import company.android.documentmanager.office.fc.codec.DigestUtils;
import company.android.documentmanager.office.fc.ddf.EscherBSERecord;
import company.android.documentmanager.office.fc.ddf.EscherBitmapBlip;
import company.android.documentmanager.office.fc.ddf.EscherBlipRecord;
import company.android.documentmanager.office.fc.ddf.EscherRecord;
import company.android.documentmanager.office.fc.hssf.OldExcelFormatException;
import company.android.documentmanager.office.fc.hssf.formula.FormulaShifter;
import company.android.documentmanager.office.fc.hssf.formula.SheetNameFormatter;
...
import company.android.documentmanager.office.fc.hssf.model.DrawingManager2;
...
import company.android.documentmanager.office.fc.hssf.model.RecordStream;
import company.android.documentmanager.office.fc.hssf.record.AbstractEscherHolderRecord;
...
import company.android.documentmanager.office.fc.hssf.record.EmbeddedObjectRefSubRecord;
...
import company.android.documentmanager.office.fc.hssf.record.RecordFactory;
import company.android.documentmanager.office.fc.hssf.record.SSTRecord;
import company.android.documentmanager.office.fc.hssf.record.SubRecord;
...
import company.android.documentmanager.office.fc.hssf.util.CellReference;
import company.android.documentmanager.office.fc.poifs.filesystem.DirectoryNode;
import company.android.documentmanager.office.fc.poifs.filesystem.POIFSFileSystem;
import company.android.documentmanager.office.fc.ss.usermodel.IRow.MissingCellPolicy;
import company.android.documentmanager.office.fc.ss.util.WorkbookUtil;
 ...
 */
public final class HSSFWorkbook extends POIDocument implements company.android.documentmanager.office.fc.ss.usermodel.Workbook
{
     ...
     *  preserveNodes whether to preseve other nodes, such as
...
//            names.add(name);
    ...
    /**
      ...
      * the Workbook.
      *
      *  records a collection of sheet's records.
     ...
     */
    public int getSheetIndex(company.android.documentmanager.office.fc.ss.usermodel.Sheet sheet)
    {
...
//        return newName;
     ...
     * @see company.android.documentmanager.office.fc.hssf.record.FormatRecord
     * @see Record
     */
     ...
     *  format            The format of the picture.  One of <code>PICTURE_TYPE_*</code>
     *
     ...
     *
     *  escherRecords the escher records.
     *  pictures the list to populate with the pictures.
     */
     ...
     *  objects the list of embedded objects to populate.
     */
