 ...
 * 时间:              上午9:08:14
 */
package company.android.documentmanager.office.mycommsmoms.pictureefftect;
...
public class PictureEffectInfoFactory
{
    ...
    public static PictureEffectInfo getPictureEffectInfor(company.android.documentmanager.office.fc.hwpf.usermodel.Picture pic)
    {
    	if(pic == null)
        {
            return null;
