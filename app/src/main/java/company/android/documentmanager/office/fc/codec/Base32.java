...
package company.android.documentmanager.office.fc.codec;
...
public class Base32 extends BaseNCodec {
     ...
     * <code>decodeSize = { - 1 + lineSeparator.length;</code>
     */
    ...
    /**
     * Convenience variable to help us determine when our buffer is going to run out of room and needs resizing.
     * <code>encodeSize = {@li + lineSeparator.length;</code>
     */
     ...
     * When encoding the line length is 0 (no chunking).
     * </p>
     *  useHex if <code>true</code> then use Base32 Hex alphabet
     */
     ...
     *  lineSeparator
     *            Each line of encoded data will end with this sequence of bytes.
     *  useHex if <code>true</code>, then use Base32 Hex alphabet, otherwise use Base32 alphabet
     * @throws IllegalArgumentException
     *             The provided lineSeparator included some Base32 characters. That's not going to work!
     ...
     *
     * Output is written to {@link #buffer} as 8-bit octets, using { as the buffer position
     */
