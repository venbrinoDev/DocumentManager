...
package company.android.documentmanager.office.fc.hssf.model;
...
import company.android.documentmanager.office.fc.ddf.EscherBSERecord;
import company.android.documentmanager.office.fc.ddf.EscherBoolProperty;
import company.android.documentmanager.office.fc.ddf.EscherContainerRecord;
import company.android.documentmanager.office.fc.ddf.EscherDgRecord;
import company.android.documentmanager.office.fc.ddf.EscherDggRecord;
...
import company.android.documentmanager.office.fc.ddf.EscherRGBProperty;
import company.android.documentmanager.office.fc.ddf.EscherRecord;
import company.android.documentmanager.office.fc.ddf.EscherSimpleProperty;
import company.android.documentmanager.office.fc.ddf.EscherSpRecord;
import company.android.documentmanager.office.fc.ddf.EscherSplitMenuColorsRecord;
import company.android.documentmanager.office.fc.hssf.formula.FormulaShifter;
import company.android.documentmanager.office.fc.hssf.formula.EvaluationWorkbook.ExternalName;
import company.android.documentmanager.office.fc.hssf.formula.EvaluationWorkbook.ExternalSheet;
import company.android.documentmanager.office.fc.hssf.formula.ptg.Area3DPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.NameXPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.OperandPtg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.Ptg;
import company.android.documentmanager.office.fc.hssf.formula.ptg.Ref3DPtg;
import company.android.documentmanager.office.fc.hssf.formula.udf.UDFFinder;
import company.android.documentmanager.office.fc.hssf.record.BOFRecord;
import company.android.documentmanager.office.fc.hssf.record.BackupRecord;
import company.android.documentmanager.office.fc.hssf.record.BookBoolRecord;
import company.android.documentmanager.office.fc.hssf.record.BoundSheetRecord;
import company.android.documentmanager.office.fc.hssf.record.CodepageRecord;
import company.android.documentmanager.office.fc.hssf.record.CountryRecord;
import company.android.documentmanager.office.fc.hssf.record.DSFRecord;
import company.android.documentmanager.office.fc.hssf.record.DateWindow1904Record;
import company.android.documentmanager.office.fc.hssf.record.DrawingGroupRecord;
import company.android.documentmanager.office.fc.hssf.record.EOFRecord;
import company.android.documentmanager.office.fc.hssf.record.EscherAggregate;
import company.android.documentmanager.office.fc.hssf.record.ExtSSTRecord;
import company.android.documentmanager.office.fc.hssf.record.ExtendedFormatRecord;
import company.android.documentmanager.office.fc.hssf.record.ExternSheetRecord;
import company.android.documentmanager.office.fc.hssf.record.FileSharingRecord;
import company.android.documentmanager.office.fc.hssf.record.FnGroupCountRecord;
import company.android.documentmanager.office.fc.hssf.record.FontRecord;
import company.android.documentmanager.office.fc.hssf.record.FormatRecord;
import company.android.documentmanager.office.fc.hssf.record.HideObjRecord;
import company.android.documentmanager.office.fc.hssf.record.HyperlinkRecord;
import company.android.documentmanager.office.fc.hssf.record.InterfaceEndRecord;
import company.android.documentmanager.office.fc.hssf.record.InterfaceHdrRecord;
import company.android.documentmanager.office.fc.hssf.record.MMSRecord;
import company.android.documentmanager.office.fc.hssf.record.NameCommentRecord;
import company.android.documentmanager.office.fc.hssf.record.NameRecord;
import company.android.documentmanager.office.fc.hssf.record.PaletteRecord;
import company.android.documentmanager.office.fc.hssf.record.PasswordRecord;
import company.android.documentmanager.office.fc.hssf.record.PasswordRev4Record;
import company.android.documentmanager.office.fc.hssf.record.PrecisionRecord;
import company.android.documentmanager.office.fc.hssf.record.ProtectRecord;
import company.android.documentmanager.office.fc.hssf.record.ProtectionRev4Record;
import company.android.documentmanager.office.fc.hssf.record.RecalcIdRecord;
import company.android.documentmanager.office.fc.hssf.record.Record;
import company.android.documentmanager.office.fc.hssf.record.RefreshAllRecord;
import company.android.documentmanager.office.fc.hssf.record.SSTRecord;
import company.android.documentmanager.office.fc.hssf.record.StyleRecord;
import company.android.documentmanager.office.fc.hssf.record.SupBookRecord;
import company.android.documentmanager.office.fc.hssf.record.TabIdRecord;
import company.android.documentmanager.office.fc.hssf.record.UseSelFSRecord;
import company.android.documentmanager.office.fc.hssf.record.WindowOneRecord;
import company.android.documentmanager.office.fc.hssf.record.WindowProtectRecord;
import company.android.documentmanager.office.fc.hssf.record.WriteAccessRecord;
import company.android.documentmanager.office.fc.hssf.record.WriteProtectRecord;
import company.android.documentmanager.office.fc.hssf.record.common.UnicodeString;
import company.android.documentmanager.office.fc.hssf.util.HSSFColor;
import company.android.documentmanager.office.fc.ss.usermodel.BuiltinFormats;
import company.android.documentmanager.office.fc.util.Internal;
import company.android.documentmanager.office.fc.util.POILogFactory;
import company.android.documentmanager.office.fc.util.POILogger;
import company.android.documentmanager.office.system.AbortReaderError;
 ...
 * @see company.android.documentmanager.office.fc.hssf.usermodel.HSSFWorkbook
 */
@ Internal
public final class InternalWorkbook
{
     ...
     *  id    the number of the format record to create (meaning its position in
     ...
     *  id    the number of the extended format record to create (meaning its position in
     ...
     *  id        the number of the style record to create (meaning its position in
     *                  a file as MS Excel would create it.
     */
    ...
    */
     ...
     *
     * @see company.android.documentmanager.office.fc.hssf.usermodel.HSSFWorkbook#setForceFormulaRecalculation(boolean)
     */
