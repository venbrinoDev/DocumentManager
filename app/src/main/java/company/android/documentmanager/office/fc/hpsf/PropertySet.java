...
public class PropertySet
{
     ...
     *  offset The offset in <var>stream</var> where the stream
     ...
     *
     *  stream The {@link InputStream} to check. In order to
     ...
     *  length The significant number of bytes in the byte
     ...
     *  offset The property set stream starts at this offset
     ...
     *
     *  o the object to compare this <code>PropertySet</code> with
     * 
