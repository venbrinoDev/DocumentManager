...
public interface ICell {
     ...
     * </p>
     *
     *  formula the formula to set, e.g. <code>"SUM(C4:E4)"</code>.
     ...
     *
     *  value the error value to set this cell to.  For formulas we'll set the
     ...
     * @see company.android.documentmanager.office.ss.model.baseModel.com.smart.office.fc.ss.usermodel.Workbook#createCellStyle()
     */
