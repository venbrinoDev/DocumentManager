...
import company.android.documentmanager.office.fc.hpsf.DocumentSummaryInformation;
import company.android.documentmanager.office.fc.hpsf.MutablePropertySet;
import company.android.documentmanager.office.fc.hpsf.PropertySet;
import company.android.documentmanager.office.fc.hpsf.PropertySetFactory;
import company.android.documentmanager.office.fc.hpsf.SummaryInformation;
import company.android.documentmanager.office.fc.poifs.filesystem.DirectoryEntry;
import company.android.documentmanager.office.fc.poifs.filesystem.DirectoryNode;
import company.android.documentmanager.office.fc.poifs.filesystem.DocumentInputStream;
import company.android.documentmanager.office.fc.poifs.filesystem.Entry;
import company.android.documentmanager.office.fc.poifs.filesystem.NPOIFSFileSystem;
...
import company.android.documentmanager.office.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(company.android.documentmanager.office.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(company.android.documentmanager.office.fc.hpsf.WritingNotSupportedException wnse)
        {
