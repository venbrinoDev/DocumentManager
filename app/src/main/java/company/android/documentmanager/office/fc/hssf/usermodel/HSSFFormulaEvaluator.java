...
import company.android.documentmanager.office.fc.hssf.formula.CollaboratingWorkbooksEnvironment;
import company.android.documentmanager.office.fc.hssf.formula.IStabilityClassifier;
import company.android.documentmanager.office.fc.hssf.formula.WorkbookEvaluator;
...
import company.android.documentmanager.office.fc.ss.usermodel.CellValue;
import company.android.documentmanager.office.fc.ss.usermodel.FormulaEvaluator;
import company.android.documentmanager.office.fc.ss.usermodel.ICell;
import company.android.documentmanager.office.fc.ss.usermodel.Workbook;
...
public class HSSFFormulaEvaluator implements FormulaEvaluator
{
    ...
    /**
     *  stabilityClassifier used to optimise caching performance. Pass <code>null</code>
     ...
     * original cell.
     *
     *  cell may be <code>null</code> signifying that the cell is not present (or blank)
     ...
     * replaced with the result of the formula, use {@link #evaluateInCell(com.com.smart.office.fc.ss.usermodel.ICell)}
