...
package company.android.documentmanager.office.fc.hwpf.sprm;
...
import company.android.documentmanager.office.fc.hwpf.usermodel.DateAndTime;
import company.android.documentmanager.office.fc.hwpf.usermodel.DropCapSpecifier;
import company.android.documentmanager.office.fc.hwpf.usermodel.LineSpacingDescriptor;
import company.android.documentmanager.office.fc.hwpf.usermodel.ParagraphProperties;
import company.android.documentmanager.office.fc.hwpf.usermodel.ShadingDescriptor;
...
public final class ParagraphSprmUncompressor extends SprmUncompressor
{
     ...
     * from a papx.
     *
     *  newPAP The ParagraphProperties object to perform the operation on.
     *  operand The operand that defines the operation.
     *  param The operation's parameter.
     *  varParam The operation's variable length parameter.
     *  grpprl The original papx.
     *  offset The current offset in the papx.
     *  spra A part of the sprm that defined this operation.
     */
