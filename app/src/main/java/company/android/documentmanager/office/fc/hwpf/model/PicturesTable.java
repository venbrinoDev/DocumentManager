...
package company.android.documentmanager.office.fc.hwpf.model;
...
import company.android.documentmanager.office.fc.hwpf.usermodel.Picture;
...
public final class PicturesTable
{
  ...
  */
   ...
   *  run
   *  fillBytes if true, Picture will be returned with filled byte array that represent picture's contents. If you don't want
