...
import company.android.documentmanager.office.fc.hwpf.model.Colorref;
import company.android.documentmanager.office.fc.hwpf.model.Hyphenation;
import company.android.documentmanager.office.fc.hwpf.usermodel.BorderCode;
import company.android.documentmanager.office.fc.hwpf.usermodel.CharacterProperties;
...
public final class CharacterSprmUncompressor extends SprmUncompressor
{
     ...
     * a single sprm.
     *
     *  oldCHP The base CharacterProperties.
     *  newCHP The current CharacterProperties.
     *  operand The operand defined by the sprm (See Word file format spec)
     *  param The parameter defined by the sprm (See Word file format spec)
     *  varParam The variable length parameter defined by the sprm. (See
     *        Word file format spec)
     *  grpprl The entire chpx that this operation is a part of.
     *  offset The offset in the grpprl of the next sprm
     *  styleSheet The StyleSheet for this document.
     */
