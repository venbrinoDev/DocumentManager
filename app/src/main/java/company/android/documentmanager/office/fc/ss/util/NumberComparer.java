...
import static company.android.documentmanager.office.fc.ss.util.IEEEDouble.*;
...
public final class NumberComparer {
	 ...
	 *  isNegative both values are either negative or positive. This parameter affects the sign of the comparison result
