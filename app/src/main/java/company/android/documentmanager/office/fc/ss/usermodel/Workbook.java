...
public interface Workbook {
     ...
     * @see {@link com.smart.fc.ss.util.WorkbookUtil#createSafeSheetName(String nameProposal)}
   ...
   // String getSheetName(int sheet);
    ...
    /**
     *  hiddenFlag pass <code>false</code> to make the workbook visible in the GUI
     */
     ...
     * </ul>
     *  sheetIx the sheet index (0-based)
     *  hidden one of the following <code>Workbook</code> constants:
