...
public interface IRow extends Iterable<ICell> {
     ...
     * @see #getCell(int, com.com.smart.office.fc.ss.usermodel.IRow.MissingCellPolicy)
     */
    ICell getCell(int cellnum);
    
    /**
     * Returns the cell at the given (0 based) index, with the specified {@link com.com.smart.office.fc.ss.usermodel.IRow.MissingCellPolicy}
     *
     ...
     *
     *  height the height in points. <code>-1</code>  resets to the default height
     */
