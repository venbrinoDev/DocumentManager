...
public interface IOfficeToPicture
{
    ...
    public static final String INSTANCE_CLASS_PATH = "company.android.documentmanager.office.officereader.OfficeToPicture";
     ...
     * 
     *  visibleWidth  engine组件的可视图宽度
     *  visibleHeight engine组件的可视图高度
