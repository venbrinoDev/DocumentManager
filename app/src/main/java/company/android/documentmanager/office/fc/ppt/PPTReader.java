 ...
 * 时间:               下午4:23:51
 */
package company.android.documentmanager.office.fc.ppt;
...
import company.android.documentmanager.office.mycommsmoms.PaintKit;
import company.android.documentmanager.office.mycommsmoms.autoshape.ExtendPath;
import company.android.documentmanager.office.mycommsmoms.autoshape.pathbuilder.ArrowPathAndTail;
import company.android.documentmanager.office.mycommsmoms.bg.BackgroundAndFill;
import company.android.documentmanager.office.mycommsmoms.bg.Gradient;
import company.android.documentmanager.office.mycommsmoms.bg.LinearGradientShader;
import company.android.documentmanager.office.mycommsmoms.bg.RadialGradientShader;
import company.android.documentmanager.office.mycommsmoms.bg.TileShader;
import company.android.documentmanager.office.mycommsmoms.hyperlink.Hyperlink;
import company.android.documentmanager.office.mycommsmoms.pictureefftect.PictureEffectInfoFactory;
import company.android.documentmanager.office.mycommsmoms.shape.AbstractShape;
import company.android.documentmanager.office.mycommsmoms.shape.ArbitraryPolygonShape;
import company.android.documentmanager.office.mycommsmoms.shape.Arrow;
import company.android.documentmanager.office.mycommsmoms.shape.AutoShape;
import company.android.documentmanager.office.mycommsmoms.shape.GroupShape;
import company.android.documentmanager.office.mycommsmoms.shape.IShape;
import company.android.documentmanager.office.mycommsmoms.shape.LineShape;
import company.android.documentmanager.office.mycommsmoms.shape.PictureShape;
import company.android.documentmanager.office.mycommsmoms.shape.ShapeTypes;
import company.android.documentmanager.office.mycommsmoms.shape.TableCell;
import company.android.documentmanager.office.mycommsmoms.shape.TableShape;
import company.android.documentmanager.office.mycommsmoms.shape.TextBox;
import company.android.documentmanager.office.valconstttaa.AutoShapeConstant;
...
import company.android.documentmanager.office.valconstttaa.wp.WPAttrConstant;
import company.android.documentmanager.office.valconstttaa.wp.WPModelConstant;
import company.android.documentmanager.office.fc.FCKit;
import company.android.documentmanager.office.fc.ShapeKit;
import company.android.documentmanager.office.fc.hslf.HSLFSlideShow;
import company.android.documentmanager.office.fc.hslf.model.Fill;
import company.android.documentmanager.office.fc.hslf.model.HeadersFooters;
import company.android.documentmanager.office.fc.hslf.model.Line;
import company.android.documentmanager.office.fc.hslf.model.MasterSheet;
import company.android.documentmanager.office.fc.hslf.model.Notes;
import company.android.documentmanager.office.fc.hslf.model.Shape;
import company.android.documentmanager.office.fc.hslf.model.ShapeGroup;
import company.android.documentmanager.office.fc.hslf.model.Sheet;
import company.android.documentmanager.office.fc.hslf.model.SimpleShape;
import company.android.documentmanager.office.fc.hslf.model.Slide;
import company.android.documentmanager.office.fc.hslf.model.SlideMaster;
import company.android.documentmanager.office.fc.hslf.model.TextShape;
import company.android.documentmanager.office.fc.hslf.model.TitleMaster;
import company.android.documentmanager.office.fc.hslf.record.BinaryTagDataBlob;
import company.android.documentmanager.office.fc.hslf.record.ClientVisualElementContainer;
import company.android.documentmanager.office.fc.hslf.record.DocumentAtom;
import company.android.documentmanager.office.fc.hslf.record.OEPlaceholderAtom;
import company.android.documentmanager.office.fc.hslf.record.PositionDependentRecordContainer;
import company.android.documentmanager.office.fc.hslf.record.Record;
import company.android.documentmanager.office.fc.hslf.record.SlideAtom;
import company.android.documentmanager.office.fc.hslf.record.SlideProgBinaryTagContainer;
import company.android.documentmanager.office.fc.hslf.record.SlideProgTagsContainer;
import company.android.documentmanager.office.fc.hslf.record.SlideShowSlideInfoAtom;
import company.android.documentmanager.office.fc.hslf.record.TimeAnimateBehaviorContainer;
import company.android.documentmanager.office.fc.hslf.record.TimeBehaviorContainer;
import company.android.documentmanager.office.fc.hslf.record.TimeColorBehaviorContainer;
import company.android.documentmanager.office.fc.hslf.record.TimeCommandBehaviorContainer;
import company.android.documentmanager.office.fc.hslf.record.TimeEffectBehaviorContainer;
import company.android.documentmanager.office.fc.hslf.record.TimeMotionBehaviorContainer;
import company.android.documentmanager.office.fc.hslf.record.TimeNodeAttributeContainer;
import company.android.documentmanager.office.fc.hslf.record.TimeNodeContainer;
import company.android.documentmanager.office.fc.hslf.record.TimeRotationBehaviorContainer;
import company.android.documentmanager.office.fc.hslf.record.TimeScaleBehaviorContainer;
import company.android.documentmanager.office.fc.hslf.record.TimeSetBehaviorContainer;
import company.android.documentmanager.office.fc.hslf.record.TimeVariant;
import company.android.documentmanager.office.fc.hslf.record.VisualShapeAtom;
import company.android.documentmanager.office.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import company.android.documentmanager.office.fc.hslf.usermodel.PictureData;
import company.android.documentmanager.office.fc.hslf.usermodel.RichTextRun;
import company.android.documentmanager.office.fc.hslf.usermodel.SlideShow;
import company.android.documentmanager.office.fc.ppt.bulletnumber.BulletNumberManage;
...
import company.android.documentmanager.office.java.awt.Rectanglef;
import company.android.documentmanager.office.java.awt.geom.Rectangle2D;
import company.android.documentmanager.office.pg.animate.ShapeAnimation;
import company.android.documentmanager.office.pg.model.PGModel;
import company.android.documentmanager.office.pg.model.PGNotes;
import company.android.documentmanager.office.pg.model.PGSlide;
import company.android.documentmanager.office.simpletext.font.FontTypefaceManage;
import company.android.documentmanager.office.simpletext.model.AttrManage;
import company.android.documentmanager.office.simpletext.model.IAttributeSet;
import company.android.documentmanager.office.simpletext.model.LeafElement;
import company.android.documentmanager.office.simpletext.model.ParagraphElement;
import company.android.documentmanager.office.simpletext.model.SectionElement;
import company.android.documentmanager.office.ss.util.format.NumericFormatter;
import company.android.documentmanager.office.system.AbstractReader;
import company.android.documentmanager.office.system.BackReaderThread;
...
{   
    ...
    private company.android.documentmanager.office.mycommsmoms.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private company.android.documentmanager.office.mycommsmoms.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        company.android.documentmanager.office.mycommsmoms.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             company.android.documentmanager.office.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new company.android.documentmanager.office.mycommsmoms.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	company.android.documentmanager.office.java.awt.Color fillColor = fill.getForegroundColor();
            	company.android.documentmanager.office.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof company.android.documentmanager.office.fc.hslf.model.AutoShape  // 文本框
                    || shape instanceof company.android.documentmanager.office.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof company.android.documentmanager.office.fc.hslf.model.Freeform
            || shape instanceof company.android.documentmanager.office.fc.hslf.model.AutoShape
            || shape instanceof company.android.documentmanager.office.fc.hslf.model.TextBox
            || shape instanceof company.android.documentmanager.office.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof company.android.documentmanager.office.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((company.android.documentmanager.office.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((company.android.documentmanager.office.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((company.android.documentmanager.office.fc.hslf.model.Freeform)shape).getFreeformPath(rect,
            ...
            else if(shape instanceof company.android.documentmanager.office.fc.hslf.model.AutoShape
                    || shape instanceof company.android.documentmanager.office.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof company.android.documentmanager.office.fc.hslf.model.Picture)
            {   
                company.android.documentmanager.office.fc.hslf.model.Picture poiPic = (company.android.documentmanager.office.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof company.android.documentmanager.office.fc.hslf.model.Table)
        {
            company.android.documentmanager.office.fc.hslf.model.Table poiTable = (company.android.documentmanager.office.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     *  pgSlide
     */
    private void processTable(PGSlide pgSlide, company.android.documentmanager.office.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                company.android.documentmanager.office.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	company.android.documentmanager.office.mycommsmoms.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            company.android.documentmanager.office.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            company.android.documentmanager.office.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != company.android.documentmanager.office.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
                                  company.android.documentmanager.office.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        company.android.documentmanager.office.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
     ...
     * 
     */
    private int converterColor(company.android.documentmanager.office.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
