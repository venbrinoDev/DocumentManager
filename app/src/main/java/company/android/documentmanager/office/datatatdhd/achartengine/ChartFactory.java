 ...
 */
package company.android.documentmanager.office.datatatdhd.achartengine;

import company.android.documentmanager.office.datatatdhd.achartengine.chart.AbstractChart;
import company.android.documentmanager.office.datatatdhd.achartengine.chart.BubbleChart;
import company.android.documentmanager.office.datatatdhd.achartengine.chart.ColumnBarChart;
import company.android.documentmanager.office.datatatdhd.achartengine.chart.CombinedXYChart;
import company.android.documentmanager.office.datatatdhd.achartengine.chart.DialChart;
import company.android.documentmanager.office.datatatdhd.achartengine.chart.DoughnutChart;
import company.android.documentmanager.office.datatatdhd.achartengine.chart.LineChart;
import company.android.documentmanager.office.datatatdhd.achartengine.chart.PieChart;
import company.android.documentmanager.office.datatatdhd.achartengine.chart.RangeBarChart;
import company.android.documentmanager.office.datatatdhd.achartengine.chart.ScatterChart;
import company.android.documentmanager.office.datatatdhd.achartengine.chart.TimeChart;
...
import company.android.documentmanager.office.datatatdhd.achartengine.model.MultipleCategorySeries;
...
import company.android.documentmanager.office.datatatdhd.achartengine.renderers.DialRenderer;
...
public class ChartFactory {
   ...
   *  dataset the multiple series dataset (cannot be null)
   *  renderer the multiple series renderer (cannot be null)
   *  format the date format pattern to be used for displaying the X axis
