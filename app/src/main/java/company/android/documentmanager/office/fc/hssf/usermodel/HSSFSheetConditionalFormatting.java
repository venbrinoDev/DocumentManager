...
import company.android.documentmanager.office.fc.hssf.record.CFRuleRecord;
import company.android.documentmanager.office.fc.hssf.record.aggregates.CFRecordsAggregate;
...
import company.android.documentmanager.office.fc.ss.usermodel.ConditionalFormatting;
import company.android.documentmanager.office.fc.ss.usermodel.ConditionalFormattingRule;
import company.android.documentmanager.office.fc.ss.usermodel.SheetConditionalFormatting;
import company.android.documentmanager.office.fc.ss.util.HSSFCellRangeAddress;
import company.android.documentmanager.office.fc.ss.util.Region;
...
public final class HSSFSheetConditionalFormatting implements SheetConditionalFormatting {
	 ...
	 *
	 *  comparisonOperation - a constant value from
	 ...
	 *  formula2 - second formula (only used with
