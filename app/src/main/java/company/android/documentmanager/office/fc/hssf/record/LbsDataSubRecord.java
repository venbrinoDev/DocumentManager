...
public class LbsDataSubRecord extends SubRecord {
     ...
     *  cbFContinued the seconf short in the record header
     *  cmoOt the containing Obj's {@link CommonObjectDataSubRecord#field_1_objectType}
     */
     ...
     * @see company.android.documentmanager.office.fc.hssf.model.ComboboxShape#createObjRecord(org.apache.poi.hssf.usermodel.HSSFSimpleShape, int)
     */
