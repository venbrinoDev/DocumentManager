...
import company.android.documentmanager.office.fc.hssf.record.AutoFilterInfoRecord;
import company.android.documentmanager.office.fc.hssf.record.CellValueRecordInterface;
import company.android.documentmanager.office.fc.hssf.record.DVRecord;
...
import company.android.documentmanager.office.fc.hssf.record.aggregates.FormulaRecordAggregate;
...
import company.android.documentmanager.office.fc.hssf.util.Region;
import company.android.documentmanager.office.fc.ss.SpreadsheetVersion;
import company.android.documentmanager.office.fc.ss.usermodel.CellRange;
import company.android.documentmanager.office.fc.ss.usermodel.DataValidation;
import company.android.documentmanager.office.fc.ss.usermodel.DataValidationHelper;
import company.android.documentmanager.office.fc.ss.usermodel.ICell;
import company.android.documentmanager.office.fc.ss.usermodel.ICellStyle;
import company.android.documentmanager.office.fc.ss.usermodel.IRow;
...
import company.android.documentmanager.office.fc.ss.util.SSCellRange;
import company.android.documentmanager.office.fc.ss.util.SheetUtil;
 ...
 */
public final class HSSFSheet implements company.android.documentmanager.office.fc.ss.usermodel.Sheet
{
     ...
     * @see HSSFRow
     * @see #removeRow(com.com.smart.office.fc.ss.usermodel.IRow)
     */
   ...
   public void setColumnPixelWidth(int columnIndex, int width)
   {
     ...
     */
    public int addMergedRegion(company.android.documentmanager.office.fc.ss.util.Region region)
    {
     ...
     *
     *  <p>
     *  Calculating the formula values with {@link company.android.documentmanager.office.fc.ss.usermodel.com.smart.office.fc.ss.usermodel.FormulaEvaluator} is the
     ...
     *  {@link company.android.documentmanager.office.ss.model.baseModel.com.smart.office.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)}
     ...
     *
     * @see company.android.documentmanager.office.ss.model.baseModel.com.smart.office.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)
     */
     ...
     *  newPrintGridlines boolean to turn on or off the printing of
     * gridlines
     */
     ...
     *  password to set for protection. Pass <code>null</code> to remove protection
     */
...
//        return cells;
    ...
    /**
     *  isInitForDraw The isInitForDraw to set.
     */
