...
import company.android.documentmanager.office.fc.ss.usermodel.Name;
...
public final class HSSFName implements Name {
     ...
     *  book workbook object associated with the sheet.
     */
     ...
     * @see HSSFWorkbook#createName()
     *  name the Name Record
     *  comment the Name Comment Record, optional.
     *  book workbook object associated with the sheet.
     */
...
//        return HSSFFormulaParser.toFormulaString(_book, ptgs);
     ...
     *
     *  index if greater than 0, the defined name is a local name and the value MUST be a 0-based index
     ...
     *
     *  value <code>true</code> indicates the name refers to a function.
     */
