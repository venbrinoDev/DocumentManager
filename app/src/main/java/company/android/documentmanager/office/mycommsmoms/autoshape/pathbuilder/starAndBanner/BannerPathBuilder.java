 ...
 * 时间:              下午4:57:48
 */
package company.android.documentmanager.office.mycommsmoms.autoshape.pathbuilder.starAndBanner;
...
public class BannerPathBuilder
{
    ...
    /**
     * 
     *  startX start point of bezier line
     *  startY
     *  p1X   p1, p2 are point in the bezier line(between start and end)
     *  p1Y
     *  p2X
     *  p2Y
     *  endX  end point of bezier line
     *  endY
     * @return
     */
    ...
    /**
     * 
     *  startX start of the bezier
     *  startY
     *  endX  end of the bezier
     *  endY
     *  pointX point in the bezier line
     *  pointY
     *  fU
     * @return
     */
