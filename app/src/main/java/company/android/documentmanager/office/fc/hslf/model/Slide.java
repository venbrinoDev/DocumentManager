...
import company.android.documentmanager.office.fc.hslf.record.ColorSchemeAtom;
import company.android.documentmanager.office.fc.hslf.record.Comment2000;
...
public final class Slide extends Sheet
{
     ...
     */
    public Slide(company.android.documentmanager.office.fc.hslf.record.Slide slide, Notes notes, SlideAtomsSet atomSet,
    ...
    */
    ...
    {
        super(new company.android.documentmanager.office.fc.hslf.record.Slide(), sheetNumber);
        _slideNo = slideNumber;
    ...
    * @see company.android.documentmanager.office.fc.hslf.usermodel.SlideShow#reorderSlide(int, int)
    */
     ...
     */
    public company.android.documentmanager.office.fc.hslf.record.Slide getSlideRecord()
    {
        return (company.android.documentmanager.office.fc.hslf.record.Slide)getSheetContainer();
    }
     ...
     *
     *  flag  <code>true</code> if the slide follows master,
     ...
     *
     *  flag  <code>true</code> if the slide draws master sheet objects,
     * <code>false</code> otherwise
     */
     ...
     *
     *  flag  <code>true</code> if the slide draws master color scheme,
     * <code>false</code> otherwise
     */
