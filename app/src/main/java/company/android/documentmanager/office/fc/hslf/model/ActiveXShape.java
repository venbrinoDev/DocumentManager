...
import company.android.documentmanager.office.fc.hslf.record.OEShapeAtom;
...
public final class ActiveXShape extends Picture
{
    ...
    *  pictureIdx the index of the picture
    ...
    /**
      ...
      *
      *  escherRecord the <code>EscherSpContainer</code> record which holds information about
...
*/
     ...
     *
     * @see company.android.documentmanager.office.fc.hslf.usermodel.SlideShow#addMovie(String, int)
