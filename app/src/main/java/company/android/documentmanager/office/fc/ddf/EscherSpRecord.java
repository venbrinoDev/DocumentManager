...
//        System.arraycopy( data, pos + size, remainingData, 0, bytesRemaining );
     ...
     *
     *  offset   The offset into <code>data</code> to start writing the record data to.
     *  data     The byte array to serialize to.
     *  listener A listener to retrieve start and end callbacks.  Use a <code>NullEscherSerailizationListener</code> to ignore these events.
