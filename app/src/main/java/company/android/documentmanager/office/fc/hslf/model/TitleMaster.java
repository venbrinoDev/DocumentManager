...
public final class TitleMaster extends MasterSheet
{
     ...
     *
     */
    public TitleMaster(company.android.documentmanager.office.fc.hslf.record.Slide record, int sheetNo)
    {
    ...
    public MasterSheet getMasterSheet()
    {
        ...
        SlideAtom sa = ((company.android.documentmanager.office.fc.hslf.record.Slide)getSheetContainer()).getSlideAtom();
