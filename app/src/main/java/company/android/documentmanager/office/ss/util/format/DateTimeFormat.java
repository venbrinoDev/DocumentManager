...
public class DateTimeFormat
{
     ...
     * 
     *  count the number of z or Z characters in the format string; "zzz" would be 3,
     * for example.
     *  generalTimeZone true if we should use a display name ("PDT") if available;
...
/*            if (custom != null) 
 ...
 // BEGIN android-added: factored out duplication.
    /**
     *  generalTimeZone "GMT-08:00" rather than "-0800".
     */
