...
public class MutableSection extends Section
{
     ...
     * <p>Sets the section's format ID.</p>
     *
     *  formatID The section's format ID as a byte array. It components
     ...
     *  value The property's value. It will be written as a Unicode
     * string.
     *
     ...
     *
     *  id The property ID.
     *  value The property's value. The value's class must be one of those
     *        supported by HPSF.
     */
