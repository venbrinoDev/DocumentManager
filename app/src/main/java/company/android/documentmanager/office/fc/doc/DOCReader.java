...
package company.android.documentmanager.office.fc.doc;
...
import company.android.documentmanager.office.mycommsmoms.bookmark.Bookmark;
import company.android.documentmanager.office.mycommsmoms.borders.Border;
import company.android.documentmanager.office.mycommsmoms.borders.Borders;
import company.android.documentmanager.office.mycommsmoms.borders.Line;
import company.android.documentmanager.office.mycommsmoms.bulletnumber.ListData;
import company.android.documentmanager.office.mycommsmoms.bulletnumber.ListLevel;
import company.android.documentmanager.office.mycommsmoms.hyperlink.Hyperlink;
import company.android.documentmanager.office.mycommsmoms.picture.Picture;
...
import company.android.documentmanager.office.mycommsmoms.shape.WPAbstractShape;
import company.android.documentmanager.office.mycommsmoms.shape.WPAutoShape;
import company.android.documentmanager.office.mycommsmoms.shape.WPGroupShape;
import company.android.documentmanager.office.mycommsmoms.shape.WPPictureShape;
...
import company.android.documentmanager.office.fc.ddf.EscherContainerRecord;
import company.android.documentmanager.office.fc.ddf.EscherOptRecord;
import company.android.documentmanager.office.fc.ddf.EscherProperties;
import company.android.documentmanager.office.fc.ddf.EscherSimpleProperty;
import company.android.documentmanager.office.fc.ddf.EscherTextboxRecord;
import company.android.documentmanager.office.fc.hwpf.HWPFDocument;
import company.android.documentmanager.office.fc.hwpf.model.FieldsDocumentPart;
import company.android.documentmanager.office.fc.hwpf.model.ListFormatOverride;
import company.android.documentmanager.office.fc.hwpf.model.ListTables;
import company.android.documentmanager.office.fc.hwpf.model.POIListData;
import company.android.documentmanager.office.fc.hwpf.model.POIListLevel;
import company.android.documentmanager.office.fc.hwpf.model.PicturesTable;
import company.android.documentmanager.office.fc.hwpf.usermodel.Bookmarks;
import company.android.documentmanager.office.fc.hwpf.usermodel.BorderCode;
import company.android.documentmanager.office.fc.hwpf.usermodel.CharacterRun;
import company.android.documentmanager.office.fc.hwpf.usermodel.Field;
import company.android.documentmanager.office.fc.hwpf.usermodel.HWPFAutoShape;
import company.android.documentmanager.office.fc.hwpf.usermodel.HWPFShape;
import company.android.documentmanager.office.fc.hwpf.usermodel.HWPFShapeGroup;
import company.android.documentmanager.office.fc.hwpf.usermodel.HeaderStories;
import company.android.documentmanager.office.fc.hwpf.usermodel.InlineWordArt;
import company.android.documentmanager.office.fc.hwpf.usermodel.LineSpacingDescriptor;
import company.android.documentmanager.office.fc.hwpf.usermodel.OfficeDrawing;
import company.android.documentmanager.office.fc.hwpf.usermodel.OfficeDrawings;
import company.android.documentmanager.office.fc.hwpf.usermodel.POIBookmark;
import company.android.documentmanager.office.fc.hwpf.usermodel.Paragraph;
import company.android.documentmanager.office.fc.hwpf.usermodel.PictureType;
import company.android.documentmanager.office.fc.hwpf.usermodel.Range;
import company.android.documentmanager.office.fc.hwpf.usermodel.Section;
import company.android.documentmanager.office.fc.hwpf.usermodel.Table;
import company.android.documentmanager.office.fc.hwpf.usermodel.TableCell;
import company.android.documentmanager.office.fc.hwpf.usermodel.TableRow;
import company.android.documentmanager.office.fc.util.LittleEndian;
import company.android.documentmanager.office.java.awt.Rectangle;
import company.android.documentmanager.office.java.util.Arrays;
...
import company.android.documentmanager.office.simpletext.view.PageAttr;
...
import company.android.documentmanager.office.pdfffwp.datamodel.CellElement;
import company.android.documentmanager.office.pdfffwp.datamodel.HFElement;
import company.android.documentmanager.office.pdfffwp.datamodel.RowElement;
import company.android.documentmanager.office.pdfffwp.datamodel.TableElement;
import company.android.documentmanager.office.pdfffwp.datamodel.WPDocument;
...
public class DOCReader extends AbstractReader
{
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	company.android.documentmanager.office.java.awt.Color fillColor = shape.getForegroundColor();
            	company.android.documentmanager.office.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
     ...
     *  autoShape
     *  section
     *  startPara start with startPara-th paragraph
     *  endPara not contain end para
     */
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            company.android.documentmanager.office.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            company.android.documentmanager.office.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
