...
public class ExOleObjAtom extends RecordAtom {
     ...
     * icon is visible.
     *
     *  aspect the draw aspect, one of the {@code DRAW_ASPECT_*} constants.
     */
     ...
     *
     *  type the type, one of the {@code TYPE_EMBEDDED_*} constants.
     */
     ...
     *
     *  type the sub-type, one of the {@code SUBTYPE_*} constants.
     */
     ...
     *
     *  ref the reference to the persistent object, corresponds with an
     *         {@code ExOleObjStg} storage container.
     */
