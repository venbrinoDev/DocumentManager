...
import company.android.documentmanager.office.fc.hssf.record.CFHeaderRecord;
import company.android.documentmanager.office.fc.hssf.record.CalcCountRecord;
import company.android.documentmanager.office.fc.hssf.record.CalcModeRecord;
import company.android.documentmanager.office.fc.hssf.record.CellValueRecordInterface;
import company.android.documentmanager.office.fc.hssf.record.ColumnInfoRecord;
import company.android.documentmanager.office.fc.hssf.record.ContinueRecord;
import company.android.documentmanager.office.fc.hssf.record.DVALRecord;
import company.android.documentmanager.office.fc.hssf.record.DefaultColWidthRecord;
import company.android.documentmanager.office.fc.hssf.record.DefaultRowHeightRecord;
import company.android.documentmanager.office.fc.hssf.record.DeltaRecord;
import company.android.documentmanager.office.fc.hssf.record.DimensionsRecord;
import company.android.documentmanager.office.fc.hssf.record.DrawingRecord;
...
import company.android.documentmanager.office.fc.hssf.record.FeatHdrRecord;
import company.android.documentmanager.office.fc.hssf.record.FeatRecord;
import company.android.documentmanager.office.fc.hssf.record.GridsetRecord;
import company.android.documentmanager.office.fc.hssf.record.GutsRecord;
import company.android.documentmanager.office.fc.hssf.record.IndexRecord;
import company.android.documentmanager.office.fc.hssf.record.IterationRecord;
import company.android.documentmanager.office.fc.hssf.record.MergeCellsRecord;
import company.android.documentmanager.office.fc.hssf.record.NoteRecord;
import company.android.documentmanager.office.fc.hssf.record.ObjRecord;
import company.android.documentmanager.office.fc.hssf.record.PaneRecord;
import company.android.documentmanager.office.fc.hssf.record.PrintGridlinesRecord;
import company.android.documentmanager.office.fc.hssf.record.PrintHeadersRecord;
import company.android.documentmanager.office.fc.hssf.record.Record;
import company.android.documentmanager.office.fc.hssf.record.RecordBase;
import company.android.documentmanager.office.fc.hssf.record.RefModeRecord;
import company.android.documentmanager.office.fc.hssf.record.RowRecord;
import company.android.documentmanager.office.fc.hssf.record.SCLRecord;
import company.android.documentmanager.office.fc.hssf.record.SaveRecalcRecord;
import company.android.documentmanager.office.fc.hssf.record.SelectionRecord;
import company.android.documentmanager.office.fc.hssf.record.TextObjectRecord;
import company.android.documentmanager.office.fc.hssf.record.UncalcedRecord;
import company.android.documentmanager.office.fc.hssf.record.WSBoolRecord;
import company.android.documentmanager.office.fc.hssf.record.WindowTwoRecord;
import company.android.documentmanager.office.fc.hssf.record.aggregates.ChartSubstreamRecordAggregate;
import company.android.documentmanager.office.fc.hssf.record.aggregates.ColumnInfoRecordsAggregate;
import company.android.documentmanager.office.fc.hssf.record.aggregates.ConditionalFormattingTable;
import company.android.documentmanager.office.fc.hssf.record.aggregates.CustomViewSettingsRecordAggregate;
import company.android.documentmanager.office.fc.hssf.record.aggregates.DataValidityTable;
import company.android.documentmanager.office.fc.hssf.record.aggregates.MergedCellsTable;
import company.android.documentmanager.office.fc.hssf.record.aggregates.PageSettingsBlock;
import company.android.documentmanager.office.fc.hssf.record.aggregates.RecordAggregate;
import company.android.documentmanager.office.fc.hssf.record.aggregates.RowRecordsAggregate;
import company.android.documentmanager.office.fc.hssf.record.aggregates.WorksheetProtectionBlock;
import company.android.documentmanager.office.fc.hssf.record.aggregates.RecordAggregate.PositionTrackingVisitor;
import company.android.documentmanager.office.fc.hssf.record.aggregates.RecordAggregate.RecordVisitor;
import company.android.documentmanager.office.fc.hssf.record.chart.ChartRecord;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFChart;
import company.android.documentmanager.office.fc.hssf.util.ColumnInfo;
import company.android.documentmanager.office.fc.hssf.util.HSSFPaneInformation;
import company.android.documentmanager.office.fc.ss.util.HSSFCellRangeAddress;
 ...
 * @see company.android.documentmanager.office.fc.hssf.usermodel.HSSFSheet
 */
@ Internal
public final class InternalSheet
{
     ...
     *  bofRecordIndex index of record after which INDEX record is to be placed
     ...
     *  indent        if true the group will be indented by one level,
