 ...
 * 时间:              上午10:53:24
 */
package company.android.documentmanager.office.pg.control;
...
import company.android.documentmanager.office.pg.view.SlideDrawKit;
...
import company.android.documentmanager.office.system.SysKit;
...
public class PGPrintMode extends FrameLayout implements IPageListViewListener
{
     ...
     * 
     *        v             event source
     *        e1            MotionEvent instance
     *        e2            MotionEvent instance
     *        velocityX     x axis velocity
     *        velocityY     y axis velocity
    ...
    /**
     *  isDrawPictrue The isDrawPictrue to set.
     */
