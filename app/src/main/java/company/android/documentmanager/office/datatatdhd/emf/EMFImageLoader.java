...
import company.android.documentmanager.office.datatatdhd.emf.data.BitmapInfoHeader;
import company.android.documentmanager.office.datatatdhd.emf.data.BlendFunction;
...
public class EMFImageLoader {
    ...
    public static Bitmap readImage(
        ...
        if (bmi.getBitCount() == 1) {
            ...
            f.setSize(new company.android.documentmanager.office.java.awt.Dimension(width + 20, height + 20));
            f.setVisible(true);*/
