...
package company.android.documentmanager.office.fc.poifs.eventfilesystem;
...
import company.android.documentmanager.office.fc.poifs.filesystem.POIFSDocument;
import company.android.documentmanager.office.fc.poifs.filesystem.POIFSDocumentPath;
...
public class POIFSReader
{
     ...
     *
     *  listener the listener to be registered
     *  path the document path; if null, the root directory is
     *             assumed
     *  name the document name
     *
     * @exception NullPointerException if listener is null or name is
