...
import company.android.documentmanager.office.system.beans.pagelist.IPageListViewListener;
...
public class Application
{
     ...
     * Constructor
     * 
     *  frame IMainFrame instance
     *  parent office engine component parent
     */
     ...
     * 
     *  listener OfficeToPictureListener instance
     */
     ...
     * 
     *  listener OpenFileFinishListener instance
     */
     ...
     * 
     *  listener  TouchEventListener instance
     */
     ...
     * 
     *  listener  UpdateStatusListener instance
     */
     ...
     * 
     *  listener ErrorListener instance
     */
    ...
    /**
     *  filePath  the open file of absolute path
     * 
...
//        }
     ...
     * 
     *  value    true  support zoom in / zoom out
     ...
     *  showPasswordDlg show password dialog or not
     */
     ...
     *  pageNumber page number (base 1)
     *  srcLeft The x coordinate of source area
     *  srcTop The y coordinate of source area
     *  srcWidth width of source area
     *  srcHeight height of source area
     *  desWidth width of destination area
     *  desHeight height of destination area
    ...
    /**
     * get sheet name
     *    sheetNumber  sheet number  (base 1)
     * 
     * @return sheet name
     */
     ...
     * get slide size 
     * 
     *  slideNumber slide number(base 1)
     * @return page size
     */
     ...
     *  slideNumber   slide number (base 1)
     *  zoomValue     0 < thumbnail zoom value <=  MAXZOOM_THUMBNAIL
     * 
     ...
     * @see #MAXZOOM_THUMBNAIL
     *  slideNumber   slide number (base 1)
     *  zoomValue     thumbnail zoom value
     * 
     * @return Bitma thumbnail image raw data 
     * 
     */
     ...
     * 
     *    resName   resource name, The value must be the same as field name in the resource file
     *    resID     The value in the "R.java"
     */
     ...
     *  duration larger than 100ms and less than 1200ms
     */
    ...
    /**
     * slideshow to image
     *  slideIndex slide index(base 1)
     *  step animation index(base 1)
     * @return
     */
     ...
     * @see #THUMBNAILSIZE
     * @see #MAXZOOM_THUMBNAIL
     *  width         thumbnail width when zoomValue is STANDARD_RATE(0 < width <= THUMBNAILSIZE)
     *  height        thumbnail height when zoomValue is STANDARD_RATE(0 < height <= THUMBNAILSIZE)
     *  zoomValue     zoom value(0 < thumbnail zoom value <=  MAXZOOM_THUMBNAIL)
     ...
     * @see #MOVING_VERTICAL
     *  position MOVING_HORIZONTAL and MOVING_VERTICAL
     */
