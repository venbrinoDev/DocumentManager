...
package company.android.documentmanager.office.fc.hssf.eventmodel;
...
public final class EventRecordFactory {
	...
	/**
	 *
	 *  sids an array of Record.sid values identifying the records
	 ...
	 *
	 *  in the InputStream from which the records will be
	 *		   obtained
	 *
