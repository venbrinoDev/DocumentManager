...
package company.android.documentmanager.office.mycommsmoms.picture;

import java.io.FileInputStream;
import java.io.InputStream;

import company.android.documentmanager.office.mycommsmoms.pictureefftect.PictureCroppedInfo;
import company.android.documentmanager.office.mycommsmoms.pictureefftect.PictureEffectInfo;
import company.android.documentmanager.office.mycommsmoms.pictureefftect.PictureEffectUtil;
...
public class PictureKit
{
     ...
     *  y              y值
     *  zoom           是否缩放
     *  destWidth      如果缩放，指定缩放后的宽度
     *  destHeight     如果缩放，指定缩放后的高度
     *
