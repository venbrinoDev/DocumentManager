...
package company.android.documentmanager.office.fc.poifs.property;
...
import company.android.documentmanager.office.fc.hpsf.ClassID;
import company.android.documentmanager.office.fc.poifs.common.POIFSConstants;
import company.android.documentmanager.office.fc.util.ByteField;
...
public abstract class Property implements Child
{
     ...
     * Set the next Child
     *
     *  child the new 'next' child; may be null, which has the
     ...
     *
     *  child the new 'previous' child; may be null, which has
