...
package company.android.documentmanager.office.fc.ddf;
...
public final class EscherDump {
     ...
     *
     *  propertyId    The property number for the name
     ...
     *
     *  bytes     How many bytes this hex value consists of.
     *  in        The stream to read the hex value from.
     *  out       The stream to write the nicely formatted hex value to.
     */
