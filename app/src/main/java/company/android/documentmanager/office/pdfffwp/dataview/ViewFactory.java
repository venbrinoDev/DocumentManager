...
public class ViewFactory
{
     ...
     * 
     *  elem          model元素
     *  paraElem      model中段落元素，只有创建leafView才需要，其它view时，传null就可以了
     *  viewType      视图类型
     * @return
     */
            ...
            case WPViewConstant.LEAF_VIEW:
                ...
                if (AttrManage.instance().hasAttribute(elem.getAttribute(), AttrIDConstant.FONT_SHAPE_ID))
                {
                    ...
                    if (shape != null)
                    {
                        ...
                        {
                            view = new ObjView(paraElem, elem, (company.android.documentmanager.office.mycommsmoms.shape.WPAutoShape)shape);
                        }
                    }
                    else
                    {
