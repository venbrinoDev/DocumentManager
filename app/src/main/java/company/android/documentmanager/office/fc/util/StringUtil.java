 ...
 *
 * Note - none of the methods in this class deals with {@link company.android.documentmanager.office.fc.hssf.record.ContinueRecord}s.  For such
...
public class StringUtil {
	 ...
	 *   offset  the initial offset into the
	 ...
	 *   offset  an offset into the byte arrat at which the data is start
	 *      when written
	 */
