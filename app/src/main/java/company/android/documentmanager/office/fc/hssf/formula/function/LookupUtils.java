...
package company.android.documentmanager.office.fc.hssf.formula.function;


import company.android.documentmanager.office.fc.hssf.formula.TwoDEval;
...
import company.android.documentmanager.office.fc.hssf.formula.eval.NumericValueEval;
...
final class LookupUtils {
	 ...
	 *  rangeLookupArg must not be <code>null</code>
	 */
	 ...
	 *  lookupValue the value to be found in column or row vector
	 *  vector the values to be searched. For VLOOKUP this is the first column of the
	 ...
	 *  midIx 'mid' index (value which has the wrong type)
