...
public final class AutoShapes
{
     ...
     *  type shape type see {@link ShapeTypes}
     *
     ...
     *
    */
    public static company.android.documentmanager.office.java.awt.Shape transform(company.android.documentmanager.office.java.awt.Shape outline, Rectangle2D anchor)
    {
    ...
    static
    {
        ...
        {
            public company.android.documentmanager.office.java.awt.Shape getOutline(Shape shape)
            {
