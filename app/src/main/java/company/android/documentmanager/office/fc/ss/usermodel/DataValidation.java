...
public interface DataValidation {
	 ...
	 * 
	 *  allowed <code>true</code> if this object should treats empty as valid value , <code>false</code>
	 *            otherwise
	 */
	 ...
	 * 
	 *  show <code>true</code> if an prompt box should be displayed , <code>false</code> otherwise
	 */
	 ...
	 * 
	 *  show <code>true</code> if an error box should be displayed , <code>false</code> otherwise
	 */
