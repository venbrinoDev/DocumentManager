...
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(company.android.documentmanager.office.fc.ss.usermodel.Workbook workbook) {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(company.android.documentmanager.office.fc.ss.usermodel.Workbook parentWorkbook) {
