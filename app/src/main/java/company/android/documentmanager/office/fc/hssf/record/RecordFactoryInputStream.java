...
import company.android.documentmanager.office.fc.hssf.eventusermodel.HSSFEventFactory;
import company.android.documentmanager.office.fc.hssf.eventusermodel.HSSFListener;
import company.android.documentmanager.office.fc.hssf.record.crypto.Biff8EncryptionKey;
...
public final class RecordFactoryInputStream {
	...
	/**
	 *  shouldIncludeContinueRecords caller can pass <code>false</code> if loose
