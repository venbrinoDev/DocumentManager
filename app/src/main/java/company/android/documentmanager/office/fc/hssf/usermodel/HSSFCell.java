...
import company.android.documentmanager.office.fc.hssf.record.CommonObjectDataSubRecord;
...
import company.android.documentmanager.office.fc.ss.usermodel.Comment;
import company.android.documentmanager.office.fc.ss.usermodel.FormulaError;
...
import company.android.documentmanager.office.fc.ss.usermodel.IHyperlink;
import company.android.documentmanager.office.fc.ss.usermodel.RichTextString;
...
import company.android.documentmanager.office.fc.ss.util.NumberToTextConverter;
...
public class HSSFCell implements ICell {
     ...
     * a date.
     *
     *  value  the date value to set this cell to.  For formulas we'll set the
     *        precalculated value, for numerics we'll set its value. For other types we
     *        will change the cell to a numeric cell and set its value.
     */
     ...
     *
     *  value value to set the cell to.  For formulas we'll set the formula
...
//        agg.setParsedExpression(ptgs);
     ...
     *
     *  value the boolean value to set this cell to.  For formulas we'll set the
     ...
     *
     *  errorCode the error value to set this cell to.  For formulas we'll set the
     ...
     * @see HSSFRow#removeCell(com.com.smart.office.fc.ss.usermodel.ICell)
    ...
    /**
     *  rangeAddressIndex The rangeAddressIndex to set.
     */
