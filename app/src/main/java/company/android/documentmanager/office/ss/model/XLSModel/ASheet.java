 ...
 * 时间:              下午1:55:20
 */
package company.android.documentmanager.office.ss.model.XLSModel;
...
import company.android.documentmanager.office.mycommsmoms.shape.AChart;
...
import company.android.documentmanager.office.valconstttaa.SSConstant;
import company.android.documentmanager.office.fc.hssf.model.InternalSheet;
import company.android.documentmanager.office.fc.hssf.model.InternalWorkbook;
import company.android.documentmanager.office.fc.hssf.record.BlankRecord;
...
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFAutoShape;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFChart;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFChildAnchor;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFClientAnchor;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFFreeform;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFLine;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFPatriarch;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFPicture;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFPictureData;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFRichTextString;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFShape;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFShapeGroup;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFSheet;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFTextbox;
import company.android.documentmanager.office.fc.hssf.usermodel.HSSFWorkbook;
...
import company.android.documentmanager.office.fc.xls.ChartConverter;
import company.android.documentmanager.office.java.awt.Rectangle;
import company.android.documentmanager.office.ss.model.CellRangeAddress;
import company.android.documentmanager.office.ss.model.baseModel.Cell;
import company.android.documentmanager.office.ss.model.baseModel.Row;
import company.android.documentmanager.office.ss.model.baseModel.Sheet;
import company.android.documentmanager.office.ss.model.baseModel.Workbook;
import company.android.documentmanager.office.ss.model.drawing.AnchorPoint;
import company.android.documentmanager.office.ss.model.drawing.CellAnchor;
import company.android.documentmanager.office.ss.model.sheetProperty.PaneInformation;
import company.android.documentmanager.office.ss.util.ModelUtil;
import company.android.documentmanager.office.ss.util.SectionElementFactory;
...
import company.android.documentmanager.office.datatatdhd.achartengine.chart.RoundChart;
import company.android.documentmanager.office.datatatdhd.achartengine.chart.XYChart;
import company.android.documentmanager.office.datatatdhd.achartengine.renderers.DefaultRenderer;
 ...
 * <p>
 */
public class ASheet extends Sheet implements company.android.documentmanager.office.fc.ss.usermodel.Sheet
{
    ...
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<company.android.documentmanager.office.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<company.android.documentmanager.office.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                company.android.documentmanager.office.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                company.android.documentmanager.office.ss.model.sheetProperty.ColumnInfo columnInfo = new company.android.documentmanager.office.ss.model.sheetProperty.ColumnInfo(
