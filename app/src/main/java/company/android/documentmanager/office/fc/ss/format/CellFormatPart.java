...
package company.android.documentmanager.office.fc.ss.format;

import static company.android.documentmanager.office.fc.ss.format.CellFormatter.logger;
import static company.android.documentmanager.office.fc.ss.format.CellFormatter.quote;
...
public class CellFormatPart
{
     ...
     *  marker The marker value to find the group of.
     *
     ...
     * there is none.
     *
     *  m The matcher for the format part.
     *
     ...
     * format part.
     *
     *  matcher The matcher for the format part.
     *
     ...
     *
     *  fdesc The format specification
     *
     ...
     *
     *  repl The original string.
     *  type The format type representation object.
     *
     ...
     *
     *  part The character to be repeated is the second character in this
     *             string.
     *
