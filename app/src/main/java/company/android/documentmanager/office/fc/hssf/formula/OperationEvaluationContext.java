...
import company.android.documentmanager.office.fc.hssf.formula.eval.NameXEval;
...
public final class OperationEvaluationContext {
	 ...
	 *  workbookName the name of the workbook containing the reference.  If <code>null</code>
	 ...
	 *  sheetName the name of the sheet containing the reference.  May be <code>null</code>
	 * (when <tt>workbookName</tt> is also null) in which case the current workbook and sheet is
	 * assumed.
	 *  refStrPart1 the single cell reference or first part of the area reference.  Must not
	 * be <code>null</code>.
	 *  refStrPart2 the second part of the area reference. For single cell references this
	 * parameter must be <code>null</code>
	 *  isA1Style specifies the format for <tt>refStrPart1</tt> and <tt>refStrPart2</tt>.
