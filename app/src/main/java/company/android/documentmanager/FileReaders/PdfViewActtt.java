...
public class PdfViewActtt extends AppCompatActivity implements OnPageChangeListener, Finsihcallback, OnLoadCompleteListener, OnPageErrorListener, OnPageScrollListener, Actions{
...
//    }
 ...
 TouchView();
    ...
    private void onClickView() {
        ...
        this.utilityAction = new UtilityAction(PdfViewActtt.this);
        isJustLoaded= true;
        performAction = new PerformAction(PdfViewActtt.this,this);
                ...
                this.pdfView.fromFile(f).spacing(4).password(str).onPageChange(this).onPageScroll(this).onLoad(this).enableAnnotationRendering(true).onError(new OnErrorListener() {
                    public void onError(Throwable th) {
                        ...
                        if (th.getLocalizedMessage().toString().equals(str)) {
                            Toast.makeText(PdfViewActtt.this, str, Toast.LENGTH_SHORT).show();
                            PdfViewActtt.this.dialogPasswordAsk();
                            return;
                        }
                        PdfViewActtt.this.errerToFileReading = true;
                        PdfViewActtt.this.errorToReadingFile();
                    }
...
//                        PdfViewActtt.this.hideLoder();
    ...
    public void dialogPasswordAsk() {
        ...
        create.setButton(-1, getString(R.string.okay), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                PdfViewActtt.this.readPDFFile(editText.getText().toString());
            }
        });
    ...
    public void dialogError() {
        ...
        builder.setIcon(R.drawable.pdf_file);
        ...
        if (this.intentAction.equals("a")) {
            builder.setPositiveButton("Open With", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
                    PdfViewActtt dM_ActivityPDFView = PdfViewActtt.this;
                    ConstantDataa.openPDFDocument(dM_ActivityPDFView, dM_ActivityPDFView.filePath, Boolean.valueOf(true));
                }
            });
        }
        builder.setOnCancelListener(new OnCancelListener() {
            public void onCancel(DialogInterface dialogInterface) {
                PdfViewActtt.this.onBackPressed();
            }
        });
        builder.show();
    }
...
viewState.setScreenRotate(!viewState.isScreenRotate());
    ...
    private void changeDisplayLayout() {
        if (viewState.isNightMode()){
            ...
            headerView.setBackground(ContextCompat.getDrawable(PdfViewActtt.this,R.drawable.background_layout_dark));
            return;
        }
        headerView.setBackground(ContextCompat.getDrawable(PdfViewActtt.this,R.drawable.background_layout));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.action_open:
                ConstantDataa.openPDFDocument(PdfViewActtt.this,filePath);
                break;
    ...
    public void finish(boolean find) {
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                ...
                if (find){
                    bookmarkItem.setIcon(ContextCompat.getDrawable(PdfViewActtt.this,R.drawable.ic_bookmarkfile_white));
                }
